    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ajout Domaine</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal">
                </button>
            </div>
            <form method="POST" action="{{ route('add-domaine') }}" id="addDomaine">
                @csrf
...
<div class="modal fade" id="modification">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('update-domaine') }}" id="updateDomaine">
                @csrf
                @method('PUT')
