        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{route('add-contrat')}}" id="addContrat" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <!-- <div class="hidden">
                                ...
                                <div class="col-xl-6 col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label text-primary">
                                            Date
                                            <span class="required">*</span></label>
                                        <input type="date" name="date_limite" class="form-control" id="exampleFormControlInput1" placeholder="">
                                    </div>
                                    @error('date_limite')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="avatar-upload">
                                                    <div class="change-btn mt-1">
                                                        <input name="fichier" type='file' class="form-control d-none" id="pdfUpload" accept=".pdf">
                                ...
                                <div class="float-end">
                                    ...
                                    <button class="btn btn-primary me-3">Sauvegarder</button>
                                </div>
                            </div>
